...
public class ZapServiceImpl implements ZapService {
    ...
    public String EnviarSMS(String menssagem, String numero, String numeroEnvio) {
        ...
        String url_dependencia_proprias = "http://localhost:8000/send-message";
    ...
    public String Enviarbuton(Button button) {
        ...
        String url_dependencia_proprias = "http://localhost:8000/send-buttons";
        RestTemplate restTemplate = new RestTemplate();
        Gson gson = new Gson();
    ...
    public String EnviarList(Lista list) {
        ...
        String url_dependencia_proprias = "http://localhost:8000/send-lists";
        RestTemplate restTemplate = new RestTemplate();
        Gson gson = new Gson();
        MultiValueMap<String, String> headers = new LinkedMultiValueMap<>();
        headers.add("Content-Type", MediaType.APPLICATION_JSON_VALUE);
